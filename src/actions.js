...
export const actions = {
    initiateForm(context, { tofes }) {
        const { shadowRoot, form, handleFocus, handleInput, handleBlur, formStateService } = tofes;
        ...
        slots.forEach(slot => {
            ...
            htmlInputs.forEach((input, i) => {
                ...
                Object.assign(input, { formStateService, required: true, inputIndex: i });
    ...
    validateInput(context) {
        ...
        const isCustomValid = customValidationFn && customValidationFn(currentInput);
