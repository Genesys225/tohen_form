...
export default class Popover {
  constructor(trigger, options = {}) {
    const position = options.position ? options.position : "top";
    const className = options.className ? options.className : "popover";
    ...
    const popoverTemplate = document.querySelector(
      `[data-popover=${trigger.dataset.popoverTarget}]`
    );
