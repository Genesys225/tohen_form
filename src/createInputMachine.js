        ...
        states: {
            ...
            focused: {
                entry: [
                    ...
                    assign({inputStateService: (_,event) => event.currentInput.inputStateService})
                ],
                on: {
                    INPUT: {
                        target: "validating",
            ...
            validating: {
                entry: [
                    ...
                    }),
                    {
                        ...
                        exec: (ctx, event) => ctx.currentValidity === "valid" ?
                ...
                on: {
                    INPUT: { target: "", cond: () => false, actions: console.trace},
                    VALID: "valid",
                    INVALID: "invalid",
                },
            },
